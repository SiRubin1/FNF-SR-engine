...
class Note extends FlxSprite
{
	...
	public static var cachedFrames:Map<String, flixel.graphics.frames.FlxAtlasFrames> = [];
	...
	function reloadNote(?prefix:String = '', ?texture:String = '', ?suffix:String = '')
	{
		...
		{
			if (!Note.cachedFrames.exists(blahblah))
				Note.cachedFrames.set(blahblah, Paths.getSparrowAtlas(blahblah));
			frames = Note.cachedFrames.get(blahblah);
			loadNoteAnims();
